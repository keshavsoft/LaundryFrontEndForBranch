...
const jfShow = ({ inDataToShow }) => {
    ...
    jFLocalToInputDCBranchDCDetailsTextId({inDCBranchDCDetailsTextId:LocalDataToShow.BranchName })
...
let jFLocalToInputDCBranchDCDetailsTextId = ({ inDCBranchDCDetailsTextId }) => {
    let jVarLocalHtmlId = 'DCBranchCDetailsTextId';
    let jVarLocalDCFactoryDCDetailsTextId = document.getElementById(jVarLocalHtmlId);

    if (jVarLocalDCFactoryDCDetailsTextId === null === false) {
        jVarLocalDCFactoryDCDetailsTextId.value = inDCBranchDCDetailsTextId;
    };
};
export { StartFunc};
