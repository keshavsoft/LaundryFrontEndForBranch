let StartFunc = ({ inItemData, inAddOnsData }) => {
    console.log("inItemData", Object.values(inItemData));
    ...
    entries.forEach(([key, value]) => {
        ...
        let localAddonRateArray = Object.values(inItemData)[0].AddOnArray.map(element => {
        ...
        td[0].textContent = `${value.ItemName}@${value.Rate}@${localAddonArray.toString()}@${localAddonRateArray.toString()}`;
