...
const SrcFolder = "src/AdminAllDays/CommonConfig/QrCodeAtStage/BranchFilter";

const FrontEndDistFolder = "publicDir/AdminAllDays/CommonConfig/QrCodeAtStage/BranchFilter";
